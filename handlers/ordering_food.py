...
# from keyboards.make_keyboard import make_row_keyboard
...
# строки сообщают, что нижестоящая функция сработает тогда и
# только тогда, когда пользователь будет в состоянии
# OrderFood.choosing_food_name и текст сообщения будет совпадать
# с одним из элементов списка available_food_names
